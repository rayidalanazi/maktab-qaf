  ...
  return (
    <>
      <Topbar
        ...
        sub="فواتير متوافقة مع هيئة الزكاة والضريبة (ZATCA)"
        breadcrumb={["الرئيسية", "الفواتير"]}
      />
      <main className="p-4 sm:p-6 max-w-7xl w-full">
        <PageHeader
          title="الفوترة الذكية"
          sub="إصدار فواتير ضريبية إلكترونية متوافقة مع الفاتورة الإلكترونية، مع احتساب ضريبة القيمة المضافة تلقائيًا."
          actions={
        ...
        <p className="text-[11px] text-[var(--text-faint)] mt-3">
          {/* كل فاتورة تحمل رمز QR وتوقيعًا رقميًا متوافقًا مع المرحلة الثانية من الفوترة الإلكترونية */}
          جميع الفواتير تُصدر برمز QR وتوقيع رقمي متوافق مع المرحلة الثانية للفاتورة الإلكترونية.
        </p>
      </main>
    </>
  );
