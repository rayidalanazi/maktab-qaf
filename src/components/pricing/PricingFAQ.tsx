...
const QUESTIONS = [
  ...
  },
  {
    ...
    a_ar: "صراحة: أي مساعد ذكي قد يخطئ. لذلك المساعد عندنا أداة مساعدة لا رأي قانوني، والتحقق النهائي مسؤولية المحامي — مكتوب بوضوح في وثيقة الاستخدام، وكل مخرجاته تمرّ بمراجعة بشرية. التأريض على مصادر سعودية موثوقة (RAG) قيد التطوير لتقليل الأخطاء.",
  },
  {
