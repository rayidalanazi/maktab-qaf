const FEATURES = [
  ...
  },
  {
    ...
    desc: "قوالب جاهزة (دفاع، توكيل، إنذار)، workflow اعتماد متعدد المراحل، توقيع اعتماد داخلي.",
  ...
  },
  {
    ...
    desc: "فواتير ضريبية + احتساب VAT 15% + تذكير العملاء بالدفع. (الدفع المباشر عبر ميسر قريباً)",
